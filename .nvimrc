...
unlet s:cpo_save
set helplang=en
set packpath=~/.config/nvim,/etc/xdg/nvim,~/.local/share/nvim/site,/usr/local/share/nvim/site,/usr/share/nvim/site,/usr/local/Cellar/neovim/0.4.3/share/nvim/runtime,/usr/share/nvim/site/after,/usr/local/share/nvim/site/after,~/.local/share/nvim/site/after,/etc/xdg/nvim/after,~/.config/nvim/after,~/.vim
set runtimepath=~/.config/nvim,~/.config/nvim/pack/minpac/start/vim-surround,~/.config/nvim/pack/minpac/start/vim-fugitive,~/.config/nvim/pack/minpac/start/vim,~/.config/nvim/pack/minpac/start/nerdtree,~/.config/nvim/pack/minpac/start/lightline.vim,~/.config/nvim/pack/minpac/start/ctrlsf.vim,~/.config/nvim/pack/minpac/start/ctrlp.vim,~/.config/nvim/pack/minpac/start/coc.nvim,/etc/xdg/nvim,~/.local/share/nvim/site,/usr/local/share/nvim/site,/usr/share/nvim/site,/usr/local/Cellar/neovim/0.4.3/share/nvim/runtime,/usr/local/Cellar/neovim/0.4.3/share/nvim/runtime/pack/dist/opt/matchit,~/.vim/pack/minpac/start/coc.nvim,~/.vim/pack/minpac/start/vim-surround,~/.config/nvim/pack/minpac/start/vim/after,~/.config/nvim/pack/minpac/start/ctrlsf.vim/after,/usr/share/nvim/site/after,/usr/local/share/nvim/site/after,~/.local/share/nvim/site/after,/etc/xdg/nvim/after,~/.config/nvim/after,~/.vim,~/.vim/after
